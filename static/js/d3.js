d3 = (function () {
        ...
        return (
            (n.on = function (n, u) {
                ...
                return 2 > arguments.length
                    ? a && a.on
                    : (a && ((a.on = null), (e = e.slice(0, (i = e.indexOf(a))).concat(e.slice(i + 1))), r.remove(n)),
    ...
    function L(t, n) {
        ...
        return (
            ...
            arguments.length ? (e = (n / (2 * Ti)) * Math.asin(1 / t)) : ((t = 1), (e = n / 4)),
            function (r) {
    ...
    function O(t) {
        var n = [t.a, t.b],
            ...
            u = Y(n, e),
            i = U(I(e, n, -u)) || 0
        n[0] * e[1] < e[0] * n[1] && ((n[0] *= -1), (n[1] *= -1), (r *= -1), (u *= -1)),
    ...
    function K(t, n, e) {
        ...
        return (i = oa.get(t))
            ...
            : (null != t &&
                  '#' === t.charAt(0) &&
                  (4 === t.length
                      ? ((a = t.charAt(1)), (a += a), (o = t.charAt(2)), (o += o), (c = t.charAt(3)), (c += c))
                      : 7 === t.length && ((a = t.substring(1, 3)), (o = t.substring(3, 5)), (c = t.substring(5, 7))),
                  (a = parseInt(a, 16)),
                  (o = parseInt(o, 16)),
                  (c = parseInt(c, 16))),
              n(a, o, c))
    ...
    function _n(t) {
        ...
        return function (e, r) {
            ...
            var u = e.className,
                ...
                a = i ? u.baseVal : u
            r
                ? ((n.lastIndex = 0), n.test(a) || ((a = h(a + ' ' + t)), i ? (u.baseVal = a) : (e.className = a)))
                : a && ((a = h(a.replace(n, ' '))), i ? (u.baseVal = a) : (e.className = a))
        }
    }
    function wn(t, n, e) {
        function r() {
    ...
    function Hn() {
        for (var t = null, n = Ca, e = 1 / 0; n; )
            n.flush
                ? (delete qa[n.callback.id], (n = t ? (t.next = n.next) : (Ca = n.next)))
    ...
    function jn(t, n) {
        ...
        if (e.createSVGPoint) {
            ...
            return (
                Da ? ((r.x = n.pageX), (r.y = n.pageY)) : ((r.x = n.clientX), (r.y = n.clientY)),
    ...
    function Yn(t, n) {
        var e,
            ...
            a = t[u]
        return (
            i > a && ((e = r), (r = u), (u = e), (e = i), (i = a), (a = e)), (n = n(a - i)) && ((t[r] = n.floor(i)), (t[u] = n.ceil(a))), t
        )
    }
    function Un() {
        return Math
    ...
    function $n(t, n) {
        return Ci.format(',.' + Math.max(0, -Math.floor(Math.log(Xn(t, n)[2]) / Math.LN10 + 0.01)) + 'f')
    }
    function Jn(t, n, e, r) {
        var u = e(t[0], t[1]),
            i = r(n[0], n[1])
    ...
    function Gn(t, n, e, r) {
        ...
        for (t[o] < t[0] && ((t = t.slice().reverse()), (n = n.slice().reverse())); o >= ++a; )
            ...
            (e.ticks = function () {
                ...
                if (e.every(isFinite)) {
                    var i = Math.floor(e[0]),
                        ...
                        o = r(e[0]),
                        c = r(e[1])
                    if (n === Qn) for (u.push(r(i)); a > i++; ) for (var l = 9; l > 0; l--) u.push(r(i) * l)
                    else {
    ...
    function se(t) {
        function n(n) {
            ...
            for (var o, f = [], s = [], h = -1, g = n.length, p = c(e), d = c(r); g > ++h; )
                u.call(this, (o = n[h]), h) ? s.push([+p.call(this, o, h), +d.call(this, o, h)]) : s.length && (a(), (s = []))
    ...
    function xe(t, n) {
        ...
        var e = t.length != n.length,
            ...
            c = 1
        if (
            (e && ((r += 'Q' + (i[0] - (2 * a[0]) / 3) + ',' + (i[1] - (2 * a[1]) / 3) + ',' + i[0] + ',' + i[1]), (u = t[1]), (c = 2)),
            n.length > 1)
        ) {
            ;(o = n[1]),
                (i = t[c]),
            ...
            (n = Te(t[o], t[o + 1])),
                1e-6 > Math.abs(n)
                    ...
                    : ((e = a[o] / n),
                      (r = a[o + 1] / n),
                      (u = e * e + r * r),
                      u > 9 && ((u = (3 * n) / Math.sqrt(u)), (a[o] = u * e), (a[o + 1] = u * r)))
        for (o = -1; c >= ++o; )
    ...
    function De(t) {
        for (var n, e, r, u = -1, i = t.length; i > ++u; )
            (n = t[u]), (e = n[0]), (r = n[1] + Ra), (n[0] = e * Math.cos(r)), (n[1] = e * Math.sin(r))
        return t
    }
    function Le(t) {
        function n(n) {
            ...
            for (
                ...
                a.call(this, (f = n[M]), M)
                    ? (v.push([(p = +x.call(this, f, M)), (d = +_.call(this, f, M))]), y.push([+w.call(this, f, M), +S.call(this, f, M)]))
                    : v.length && (o(), (v = []), (y = []))
    ...
    function Ke(t, n, e) {
        ...
        if (((t.charge = 0), !t.leaf))
            for (var i, a = t.nodes, o = a.length, c = -1; o > ++c; )
                (i = a[c]), null != i && (Ke(i, n, e), (t.charge += i.charge), (r += i.charge * i.cx), (u += i.charge * i.cy))
        if (t.point) {
            ...
            (e.parseRows = function (t, n) {
                function e() {
                    ...
                    if (34 === t.charCodeAt(n)) {
                        ...
                        return (
                            13 === r ? ((u = !0), 10 === t.charCodeAt(e + 2) && ++f) : 10 === r && (u = !0),
        ...
        function e(n, u, i, a, o, c, l, f, s, h, g, p, d, m) {
            ...
            if (M > 4 * r && d--) {
                ...
                ;((C * C) / M > r || Math.abs((v * T + y * q) / M - 0.5) > 0.3) &&
                    (e(n, u, i, a, o, c, A, N, k, (b /= w), (x /= w), _, d, m), m.point(A, N), e(A, N, k, b, x, _, l, f, s, h, g, p, d, m))
            }
        }
        var r = 0.5,
            u = 16
    ...
    function ru() {
        function t(t, u) {
            ...
            var i = Math.cos((u *= zi)),
                ...
                c = Math.sin(u),
                l = Math.atan2(
                    Math.sqrt((l = e * c - r * o) * l + (l = r * a - n * c) * l + (l = n * o - e * a) * l),
                    n * a + e * o + r * c
                )
                ...
                v = {
                    ...
                    polygonEnd: function () {
                        ;(v.point = u),
                            ...
                            (v.lineEnd = o),
                            (s = Ci.merge(s)),
                            s.length ? cu(s, e, r) : (-qi > h || (p && -qi > g)) && (r.lineStart(), e(null, null, 1, r), r.lineEnd()),
                            r.polygonEnd(),
                            (s = null)
                    },
                    sphere: function () {
            ...
            for (var i, a, o, c = r[0]; ; ) {
                ...
                do {
                    if (((i.visited = i.other.visited = !0), i.entry)) {
                        if (i.subject) for (var l = 0; a.length > l; l++) e.point((o = a[l])[0], o[1])
                ...
                (qi > Math.abs(h - 2) && qi > Math.abs(u - 2)) ||
                    (qi > Math.abs(u) ||
                        ...
                        (qi > Math.abs(Math.abs(r - s) - Ti)
                            ? u + h > 2 && (a += 4 * (r - s))
                            : (a += qi > Math.abs(h - 2) ? 4 * (r - g) : (((3 * Ti + r - s) % (2 * Ti)) - Ti) * (h + u))),
                    (g = s),
                    (s = r),
                    (h = u))
        return a
    ...
    function du(t, n, e, r) {
        ...
        return Math.abs(a) > qi
            ? Math.atan((Math.sin(n) * (i = Math.cos(r)) * Math.sin(e) - Math.sin(r) * (u = Math.cos(n)) * Math.sin(t)) / (u * i * a))
            : (n + r) / 2
    }
    function mu(t, n, e, r) {
        var u
            ...
            return {
                ...
                point: function (o, c) {
                    var l,
                        ...
                        s = n(o, c)
                    !e && (i = u = s) && t.lineStart(),
                        s !== u && ((l = r(e, f)), (Zr(e, l) || Zr(f, l)) && ((f[0] += qi), (f[1] += qi), (s = n(f[0], f[1])))),
                        s !== u &&
                            ((a = 0),
                            (u = s)
    ...
    function Su(t, n) {
        return [t / (2 * Ti), Math.max(-0.5, Math.min(0.5, Math.log(Math.tan(Ti / 4 + n / 2)) / (2 * Ti)))]
    }
    function ku(t) {
    ...
    function Hu(t) {
        ...
        return (
            ...
            (n.rotate = function (t) {
                return arguments.length
                    ? ((d = (t[0] % 360) * zi), (m = (t[1] % 360) * zi), (v = t.length > 2 ? (t[2] % 360) * zi : 0), r())
                    : [d * Di, m * Di, v * Di]
            }),
    ...
    function Xu(t, n) {
                ...
                rightOf: function (t, n) {
                    ...
                    if (1 === e.a) {
                        ...
                        if (
                            ((!u && 0 > e.b) || (u && e.b >= 0)
                                ? (c = o = i >= e.b * a)
                                : ((c = n.x + n.y * e.b > e.c), 0 > e.b && (c = !c), c || (o = 1)),
                            !o)
                        ) {
        ...
        for (var a, o, c, l, f, s, h, g, p, d, m, v, y, M = e.list.shift(); ; )
            if ((i.empty() || (a = i.min()), M && (i.empty() || M.y < a.y || (M.y == a.y && M.x < a.x))))
                (o = r.leftBound(M)),
                    (c = r.right(o)),
                    (h = r.rightRegion(o)),
                    (v = u.bisect(h, M)),
    ...
    ;(Ci.functor = c),
        ...
        (Ci.mean = function (t, n) {
            var e,
                ...
                i = -1,
                a = 0
            if (1 === arguments.length) for (; r > ++i; ) f((e = t[i])) && (u += (e - u) / ++a)
            else for (; r > ++i; ) f((e = n.call(t, t[i], i))) && (u += (e - u) / ++a)
            return a ? u : void 0
        }),
        (Ci.median = function (t, n) {
            return arguments.length > 1 && (t = t.map(n)), (t = t.filter(f)), t.length ? Ci.quantile(t.sort(Ci.ascending), 0.5) : void 0
        }),
        (Ci.min = function (t, n) {
            var e,
                r,
        ...
        (Ci.sum = function (t, n) {
            var e,
                ...
                u = t.length,
                i = -1
            if (1 === arguments.length) for (; u > ++i; ) isNaN((e = +t[i])) || (r += e)
    ...
    ;(Ci.bisectLeft = Bi.left),
        ...
        (Ci.range = function (t, n, e) {
            if ((3 > arguments.length && ((e = 1), 2 > arguments.length && ((n = t), (t = 0))), 1 / 0 === (n - t) / e))
                throw Error('infinite range')
            var r,
                u = [],
                i = g(Math.abs(e)),
                a = -1
            if (((t *= i), (n *= i), (e *= i), 0 > e)) for (; (r = t + e * ++a) > n; ) u.push(r / i)
    ...
    ;(Ci.round = function (t, n) {
        ...
        (Ci.xhr = function (t, n, e) {
            ...
            return (
                ...
                Ci.rebind(u, i, 'on'),
                2 === arguments.length && 'function' == typeof n && ((e = n), (n = null)),
                null == e ? u : u.get(p(e))
            )
        }),
        (Ci.text = function () {
    ...
    ;(Ci.ns = {
        ...
        qualify: function (t) {
            var n = t.indexOf(':'),
                e = t
            return n >= 0 && ((e = t.substring(0, n)), (t = t.substring(n + 1))), Ji.hasOwnProperty(e) ? { space: Ji[e], local: t } : t
        },
    }),
        ...
        (Ci.format = function (t) {
            ...
            switch (
                (l && (l = +l.substring(1)),
                (a || ('0' === e && '=' === r)) && ((a = e = '0'), (r = '='), c && (o -= Math.floor((o - 1) / 4))),
                f)
            ) {
                case 'n':
                    ;(c = !0), (f = 'g')
    ...
    if (Pi) {
        ...
        Wi = function (t) {
            for (
                var n = t.lastIndexOf('.'), e = n >= 0 ? '.' + t.substring(n + 1) : ((n = t.length), ''), r = [], u = 0, i = Pi[0];
                n > 0 && i > 0;
    ...
    ;(Ci.interpolate = function (t, n) {
        ...
        (Ci.interpolateString = function (t, n) {
            ...
            for (ia.lastIndex = 0, r = 0; (e = ia.exec(n)); ++r)
                e.index && l.push(n.substring(o, (c = e.index))), f.push({ i: l.length, x: e[0] }), l.push(null), (o = ia.lastIndex)
            for (n.length > o && l.push(n.substring(o)), r = 0, i = f.length; (e = ia.exec(t)) && i > r; ++r)
                if (((a = f[r]), a.x == e[0])) {
                    if (a.i)
                        if (null == l[a.i + 1]) for (l[a.i - 1] += a.x, l.splice(a.i, 1), u = r + 1; i > u; ++u) f[u].i--
    ...
    ;(aa.brighter = function (t) {
        ...
        return n || e || r
            ? (n && u > n && (n = u),
              e && u > e && (e = u),
              r && u > r && (r = u),
              $(Math.min(255, Math.floor(n / t)), Math.min(255, Math.floor(e / t)), Math.min(255, Math.floor(r / t))))
            : $(u, u, u)
    }),
    ...
    ;(ca.brighter = function (t) {
        return (t = Math.pow(0.7, arguments.length ? t : 1)), en(this.h, this.s, this.l / t)
    }),
        (ca.darker = function (t) {
            return (t = Math.pow(0.7, arguments.length ? t : 1)), en(this.h, this.s, t * this.l)
        }),
        (ca.rgb = function () {
        ...
        (ba.select = function (t) {
            ...
            for (var a = -1, o = this.length; o > ++a; ) {
                ...
                for (var c = -1, l = r.length; l > ++c; )
                    (u = r[c]) ? (n.push((e = t.call(u, u.__data__, c))), e && '__data__' in u && (e.__data__ = u.__data__)) : n.push(null)
            }
            return mn(i)
        }),
        (ba.selectAll = function (t) {
            ...
            for (var u = -1, i = this.length; i > ++u; )
                for (var a = this[u], o = -1, c = a.length; c > ++o; )
                    (e = a[o]) && (r.push((n = Ui(t.call(e, e.__data__, o)))), (n.parentNode = e))
            return mn(r)
        }),
        ...
        (ba.data = function (t, n) {
            function e(t, e) {
                ...
                if (n) {
                    ...
                    for (r = -1; s > ++r; )
                        (m = n.call(e, (a = e[r]), r)),
                            (u = v.get(m)) ? ((g[r] = u), (u.__data__ = a)) : y.has(m) || (p[r] = kn(a)),
                            y.set(m, a),
                            v.remove(m)
            ...
            var c = qn([]),
                l = mn([]),
                f = mn([])
            if ('function' == typeof t) for (; o > ++a; ) e((r = this[a]), t.call(r, r.parentNode.__data__, a))
        ...
        (_a.select = function (t) {
            for (var n, e, r, u, i, a = [], o = -1, c = this.length; c > ++o; ) {
                ...
                for (var l = -1, f = u.length; f > ++l; )
                    (i = u[l]) ? (n.push((r[l] = e = t.call(u.parentNode, i.__data__, l))), (e.__data__ = i.__data__)) : n.push(null)
            }
            return mn(a)
        })
    var wa,
            ...
            for (var a = -1, o = this.length; o > ++a; ) {
                ...
                for (var c = this[a], l = -1, f = c.length; f > ++l; )
                    (r = c[l]) && (e = t.call(r, r.__data__, l))
                        ? ('__data__' in r && (e.__data__ = r.__data__), zn(e, l, u, r.__transition__[u]), n.push(e))
                        : n.push(null)
            }
            return Cn(i, u)
        }),
        ...
        (Sa.transition = function () {
            for (var t, n, e, r, u = this.id, i = ++ka, a = [], o = 0, c = this.length; c > o; o++) {
                ...
                for (var n = this[o], l = 0, f = n.length; f > l; l++)
                    (e = n[l]) && ((r = Object.create(e.__transition__[u])), (r.delay += r.duration), zn(e, l, i, r)), t.push(e)
            }
            return Cn(a, i)
        }),
            ...
            function t() {
                ...
                return c >= Oa
                    ...
                    ? 'M' +
                      ...
                      t * s +
                      'Z'
                    : 'M' + i * f + ',' + i * s + 'A' + i + ',' + i + ' 0 ' + l + ',1 ' + i * h + ',' + i * g + 'L0,0' + 'Z'
            }
            var n = oe,
                e = ce,
                r = le,
        ...
        (Ci.svg.chord = function () {
            function e(t, n) {
                ...
                return (
                    ...
                    (u(e, c) ? a(e.r, e.p1, e.r, e.p0) : a(e.r, e.p1, c.r, c.p0) + i(c.r, c.p1, c.a1 - c.a0) + a(c.r, c.p1, e.r, e.p0)) +
                    'Z'
                )
            }
            function r(t, n, e, r) {
        ...
        function t(i) {
            i.each(function () {
                ...
                a.style('pointer-events', 'all').on('mousedown.brush', u).on('touchstart.brush', u),
                    ...
                    h.exit().remove(),
                    o && ((i = On(o)), f.attr('x', i[0]).attr('width', i[1] - i[0]), e(a)),
                    c && ((i = On(c)), f.attr('y', i[0]).attr('height', i[1] - i[0]), r(a)),
                    n(a)
            })
        }
        function n(t) {
        ...
        function u() {
            ...
            function g(t, n, e) {
                ...
                return (
                    ...
                    S ? (u = (r += l) + s) : (d && (l = Math.max(o, Math.min(c, 2 * d[e] - r))), r > l ? ((u = r), (r = l)) : (u = l)),
                    f[0][e] !== r || f[1][e] !== u ? ((i = null), (f[0][e] = r), (f[1][e] = u), !0) : void 0
                )
            }
            function p() {
                h(),
    ...
    ;(Ci.behavior = {}),
        ...
        (Ci.behavior.zoom = function () {
            ...
            function c() {
                g || (g = n(Ci.mouse(this))), r(Math.pow(2, 0.002 * Wa()) * x), u(Ci.mouse(this), g), a(w.of(this, arguments))
            }
            function l() {
                g = null
            }
    ...
    ;(Ci.layout = {}),
        ...
        (Ci.layout.force = function () {
            ...
            return (
                ...
                (c.start = function () {
                    ...
                    for (e = 0; s > e; ++e)
                        (l = v[e]),
                            ...
                            isNaN(l.px) && (l.px = l.x),
                            isNaN(l.py) && (l.py = l.y)
                    if (((u = []), 'function' == typeof h)) for (e = 0; d > e; ++e) u[e] = +h.call(this, y[e], e)
                    else for (e = 0; d > e; ++e) u[e] = h
                    if (((i = []), 'function' == typeof g)) for (e = 0; d > e; ++e) i[e] = +g.call(this, y[e], e)
                    else for (e = 0; d > e; ++e) i[e] = g
                    if (((o = []), 'function' == typeof p)) for (e = 0; s > e; ++e) o[e] = +p.call(this, v[e], e)
                ...
                (c.drag = function () {
                    return (
                        e || (e = Ci.behavior.drag().origin(a).on('dragstart.force', Be).on('drag.force', n).on('dragend.force', $e)),
                        arguments.length ? (this.on('mouseover.force', Je).on('mouseout.force', Ge).call(e), void 0) : e
                    )
                }),
                Ci.rebind(c, l, 'on')
            )
    ...
    ;(Ci.layout.histogram = function () {
        ...
        (Ci.layout.hierarchy = function () {
            ...
            function n(t, r) {
                var u = t.children,
                    a = 0
                if (u && (o = u.length)) for (var o, c = -1, l = r + 1; o > ++c; ) a += n(u[c], l)
                ...
                function o(t, n, r) {
                    if (n) {
                        ...
                        o && !Tr(a) && ((a._tree.thread = o), (a._tree.mod += s - f)),
                            i && !Nr(c) && ((c._tree.thread = i), (c._tree.mod += l - h), (r = t))
                    }
                    return r
                }
    ...
    ;(Ci.geo.albersUsa = function () {
        ...
        return (
            (t.scale = function (n) {
                return arguments.length
                    ? (e.scale(n), r.scale(0.6 * n), u.scale(n), i.scale(1.5 * n), t.translate(e.translate()))
                    : e.scale()
            }),
            (t.translate = function (n) {
